...
<body style="background: #A8A8A8">
  <div class="right" >
        ...
        <div class="providerAdd">
            <form id="userForm" name="userForm" method="post" action="worklog!addOk.action">
               ...
               <div>
                   ...
                   <input type="text" id="year" name="year"  onclick="WdatePicker();" value=""></input>
                   
                   <font color="red"></font>
                </div>
                <div>
                    <label for="title">日志标题:</label>
                    <input type="text" name="worklog.title" id="title" value=""> 
					<font color="red"></font>
                </div>
                <div>
                    <label for="description">日志内容:</label>
                    <input type="text" name="worklog.description" id="description" value=""> 
					<font color="red"></font>
                </div>
                <div>
                    <label for="logtime">记录时间</label>
                    <input type="text" name="worklog.logtime" id="logtime" onclick="WdatePicker();" value=""> 
					<font color="red"></font>
                </div>
