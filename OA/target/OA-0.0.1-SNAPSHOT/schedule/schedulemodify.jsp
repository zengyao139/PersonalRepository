...
<body style="background: #A8A8A8">
  <div class="right" >
        <div class="location">
            ...
            <span>日程安排>> 日程安排修改</span>
        </div>
        <div class="providerAdd">
            <form id="userForm" name="userForm" method="post" action="schedule!modify.action">
				<input type="hidden" name="method" value="add">
                <!--div的class 为error是验证错误，ok是验证成功-->
                <input type="hidden" name="username" value="${schedule.username }"/>
                ...
                <div>
                 ...
                 <div>
                    ...
                    <input type="text" name="plan" id="plan" value="${schedule.plan }"> 
					<!-- 放置提示信息 -->
					<font color="red"></font>
                </div>
